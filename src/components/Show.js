...
const Show = (props) => {
	...
	const regex = /(<([^>]+)>)/gi;
	const summary = showData?.summary?.replace(regex, '') ?? 'No Summary';
			...
			>
				...
				<CardContent>
					<Typography
						...
						component='span'
						sx={{
							borderBottom: '0.5px solid #1e8678',
							fontWeight: 'bold'
						}}
					>
						<dl>
							<p>
								<dt className='title'>Official Site:</dt>
